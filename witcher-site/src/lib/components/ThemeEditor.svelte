...
<div>
			...
			<button onclick={() => loadPreset(key)} class="theme-preset-btn">
				<div class="theme-preset-swatches">
					...
					<span
						...
						style="background: {PRESETS[key].colors.secondaryContainer};"
					></span>
	...
	>
		<div
			...
			style="background: {draft.primary}; color: {draft.onPrimary};"
		>
			Identity
		</div>
		<div class="theme-preview-body" style="color: {draft.onSurface};">
			...
			<div class="theme-preview-stat-row">
				<span>Vigor Pool</span>
				<span class="theme-preview-stat-value" style="color: {draft.tertiary};">100 / 100</span>
			</div>
		</div>
	</div>
