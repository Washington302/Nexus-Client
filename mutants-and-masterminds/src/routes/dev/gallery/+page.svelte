<script lang="ts">
	import GalleryShell from '@shared/dev/GalleryShell.svelte';
	import SiteNavSection from '@shared/dev/sections/SiteNavSection.svelte';
...
<GalleryShell>
	{#snippet children()}
		<EditModalSection />
		<PanelSection colors={['red', 'yellow', 'blue', 'dark']} headerPrefix="★ " />
		<SiteNavSection />
