<script lang="ts">
	...
	//         Content, so the full text below must stay reachable and complete.
	//   §15 — the COPYRIGHT NOTICE must list every work whose Open Game Content
	//         we use. Add a line here before using OGC from any new source.
	// Do not reword either block.
	const APP_NAME = 'Scribe Sheets';
</script>
...
<div class="comic-wrap">
	<SplashHeader
		title="Scribe "
		highlight="Sheets"
		subtitle="An unofficial character tool for Mutants &amp; Masterminds"
	/>

	<div style="display:flex; flex-direction:column; gap:16px; margin-top:16px;">
		<ComicPanel header="★ About" color="blue">
			<p class="legal-body">
				{APP_NAME} is an independent digital character sheet. It implements Open Game Content — point-buy
				math, power level caps, ability score mechanics, advantage rules, and equipment stats.
			</p>
			<p class="legal-body">
				It ships no Product Identity: no setting lore, no official character names, no trade dress,
				no artwork, and no company logos. You'll need the published rulebook to play.
			</p>
		</ComicPanel>

		<ComicPanel header="★ Open Game License Notice" color="dark">
			<blockquote class="legal-quote">
				{APP_NAME} uses Open Game Content under the Open Game License v1.0a. Mutants &amp; Masterminds
				and its associated logos are trademarks of Green Ronin Publishing.
			</blockquote>
		</ComicPanel>

		<ComicPanel header="★ Product Identity" color="blue">
			<p class="legal-body">
				All game mechanics in {APP_NAME} are Open Game Content. Product Identity — including the
				Mutants &amp; Masterminds and Green Ronin names and logos, setting material, and official
				character and place names — is not licensed here and is not used by this tool.
			</p>
		</ComicPanel>

		<ComicPanel header="★ Open Game License v1.0a" color="dark">
			<p class="legal-body" style="font-weight:700;">
			...
			<div class="ogl-text">
				...
				<p>
					...
					compilation, abridgment or other form in which an existing work may be recast, transformed
					or adapted; (c) "Distribute" means to reproduce, license, rent, lease, sell, broadcast,
					publicly display, transmit or otherwise distribute; (d)"Open Game Content" means the game
					...
					identity by the owner of the Product Identity, and which specifically excludes the Open
					...
					to use, Distribute, copy, edit, format, modify, translate and otherwise create Derivative
				...
				<p>
					...
					to or subtracted from this License except as described by the License itself. No other
				...
				<p>
					Mutants &amp; Masterminds Hero's Handbook, Copyright 2011, Green Ronin Publishing; Author
					Steve Kenson.
				</p>

				<p><strong>END OF LICENSE</strong></p>
			</div>
		</ComicPanel>
	</div>

	<p style="text-align:center; margin-top:16px;">
		<a href="/dashboard" style="color:var(--danger); font-weight:700;">&larr; Back to Dashboard</a>
	</p>
</div>
