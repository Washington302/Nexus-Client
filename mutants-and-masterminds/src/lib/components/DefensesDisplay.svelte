...
<div class="def-row">
	...
	<span class="input-box-demo" class:text-value={dd2.immune}>{dd2.immune ? 'None' : dd2.value}</span>
...
<div class="def-row">
	...
	<span class="input-box-demo" class:text-value={dp2.immune}>{dp2.immune ? 'None' : dp2.value}</span>
...
<div class="def-row">
	...
	<span class="input-box-demo" class:text-value={df2.immune}>{df2.immune ? 'None' : df2.value}</span>
...
<div class="def-row">
	...
	<span class="input-box-demo" class:text-value={dt2.immune}>{dt2.immune ? 'None' : dt2.value}</span>
...
<div class="def-row">
	...
	<span class="input-box-demo" class:text-value={dw2.immune}>{dw2.immune ? 'None' : dw2.value}</span>
