<script lang="ts">
	...
	const cards = [
		...
		{ href: '/log', label: 'Session Log', desc: 'Chronicle your adventures' },
...
<div class="page">
	<div class="list-header">
		...
		<p class="list-subtitle">Your Mythras command center</p>
	</div>
	...
	<div style="margin-top:16px;width:100%;">
		<Panel header="Quick Stats" color="plain">
			<div class="grid-2" style="gap:8px;">
				...
				<div class="stat-bubble">
					<div class="stat-num">{session.activeCharacter ? session.activeCharacter.name : 'None'}</div>
