<script lang="ts">
	...
	import type { MythrasCharacter, CampaignSession } from '$lib/services/api';
	...
	$effect(() => {
		if (session.activeCharacter && !draft) {
			const loaded: MythrasCharacter = JSON.parse(JSON.stringify(session.activeCharacter));
...
<div class="page">
	...
	{:else}
		<div class="list-header">
			...
			<p class="list-subtitle">A record of your adventures</p>
		</div>
