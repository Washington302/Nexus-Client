<script lang="ts">
	...
	async function handleCreate() {
		...
		createError = null;
		try {
			const created = await api.campaign.create({ name: newName, gameSystem: 'MYTHRAS' });
...
<div class="page">
	<div class="list-header">
		...
		<p class="list-subtitle">Your sagas and their rosters</p>
	</div>
		...
		>
			...
			<div class="field-group">
				...
				<input
					...
					required
					class="comic-input"
					placeholder="e.g. Shadows over Sartar"
				/>
			</div>
