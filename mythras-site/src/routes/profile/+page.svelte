...
<div class="page">
	...
	{#if session.userId}
		...
		<button onclick={handleLogout} class="comic-btn secondary" style="margin-top:16px;">Sign Out</button>

		<div style="margin-top:16px;width:100%;">
			<Panel header="Theme Editor" color="gold">
				<p style="font-family:var(--font-body);font-size:13px;color:var(--on-surface-variant);margin-bottom:12px;">
